...
class metalinking_groups_created extends \core\event\base
{
    /**
     * Init method.
     *
    ...
    public function get_description() {
        return "System groups from course with id '{$this->other['childid']}' have been created in course with id '{$this->other['parentid']}'";
    }
    ...
    public static function get_name() {
        return get_string('eventmetalinkinggroupscreated', 'local_obu_metalinking_events');
    }
     ...
     *
     * @return metalinking_groups_created
     */
